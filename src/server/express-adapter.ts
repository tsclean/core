...
import { CorsOptions, CorsOptionsDelegate } from "../contracts/cors-options";
import { InternalServerErrorException } from "../exceptions";
import { CleanExpressBodyParserOptions } from "../contracts/clean-express-body-parser-options";
import {
  VersionValue,
  VersioningOptions,
  VERSION_NEUTRAL,
  VersioningType
} from "../contracts/version-options";
import { ApplicationOptionsInterface } from "../contracts";
import { AbstractHttpAdapter } from "../core/adapters";

type VersionedRoute = <T extends Record<string, any> = any, R = any>(
  req: T,
  res: R,
  next: () => void
) => any;
...
export class ExpressAdapter extends AbstractHttpAdapter {
  ...
  public useBodyParser<Options extends bodyparser.Options = bodyparser.Options>(
    ...
    rawBody: boolean,
    options?: CleanExpressBodyParserOptions<Options>
  ): this {
