import {
    CONTROLLER_MAPPING_MESSAGE, HOST_METADATA, MODULE_PATH
} from '../helpers';
...
import {HttpServer, ResolverInterface, RoutePathMetadataInterface, Type} from "../contracts";
...
export class RoutesResolver implements ResolverInterface {
    ...
    public registerRouters(routes: Map<string | symbol | Function, InstanceWrapper<ControllerType>>,
                           moduleName: string,
                           globalPrefix: string,
                           modulePath: string,
    ...
    private static getHostMetadata(metaType: Type<unknown> | Function): string | string[] | undefined {
