...
import {HttpServer, MiddlewareConfigurationInterface, MiddlewareInterface, RouteInfo} from "../contracts";
...
export class MiddlewareModule {
    ...
    public async registerMiddlewareConfig(middlewareContainer: MiddlewareContainer,
    ...
    public async registerRouteMiddleware(middlewareContainer: MiddlewareContainer,
                                         routeInfo: RouteInfo,
                                         config: MiddlewareConfigurationInterface,
                                         moduleKey: string,
                                         applicationRef: any,
